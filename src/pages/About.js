        ...
        return (
          <div style={{margin:'20px auto', maxWidth:'960px', paddingLeft: '20px', paddingRight: '20px'}}>
            ...
            <Typography style={{lineHeight: '1.8em', fontSize: 18, textAlign: 'justify'}}>
              ...
              <Paragraph>
                “沃•双博”生态沼液肥系列产品是由天津双博农业科技有限公司与北京农林科学院共同研发、由中粮肉食（天津）有限公司和天津双博农业科技有限公司合作生产的新一代农业生产用肥。公司目前有七款产品，广泛应用于：叶菜类、果树类、粮食类、瓜果蔬菜类、园林绿化类、花卉类、中草药类等领域。公司目前在利用沼液、沼渣研制生态沼液、沼渣肥改良土壤等领域，已获取20项国家专利。在众多的同行业中形成自己的特色和优势,并通过国际质量管理体系认证。公司将坚持依靠科技服务农业，以质量求生存，以信誉求发展的宗旨，为我国的农业可持续发展和绿色有机食品基地的建设做出应有的贡献。按照公司确定的中长期战略发展目标，强化学习力、执行力建设，充分发挥公司人才、技术、管理优势、加快推进公司建设步伐，打造诚信企业，铸就“沃•双博”品牌。
              </Paragraph> 

              <Paragraph>
                企业文化<br/>
                  企业精神：老实做人，踏实做事；<br/>
                  服务宣言：客户利益第一，永远只做认为正确的事；<br/>
                  团队理念：第一时间主动解决问题；
              </Paragraph>

              <Paragraph>
                <p>公司的核心产品：</p>
                1、“沃▪双博”生态沼液肥（叶菜类专用），产品执行标准Q12SBN0001-2017；<br/>
                2、“沃▪双博”生态沼液肥（瓜果蔬菜类专用），产品执行标准Q12SBN0002-2017；<br/>
                3、“沃▪双博”生态沼液肥（粮食类专用），产品执行标准Q12SBN0003-2017；<br/>
                4、“沃▪双博”生态沼液肥（园林绿化类专用），产品执行标准Q12SBN0004-2017；<br/>
                5、“沃▪双博”生态沼液肥（花卉类专用），产品执行标准Q12SBN0005-2017；<br/>
                6、“沃▪双博”生态沼液肥（果树类专用），产品执行标准Q12SBN0006-2017；<br/>
